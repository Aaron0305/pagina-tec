...
<nav class="navbar navbar-expand-lg bg-body-tertiary" >
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup" >
        <div class="navbar-nav ml-auto">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="opciones_prom.php">Proceso de documentaci&oacute;n</a></li>
  ...
  <a class="btn btn-primary" href="opciones_prom.php" role="button">Regresar</a>
  <div id="mensaje"></div>
	<script>
      ...
      document.getElementById("mensaje").innerHTML = '<i class="fa fa-check"></i> <a href="subir.php">Archivos guardados</a>';
			...
			xhr.open('POST', 'guardarArchivos_prom.php');
			xhr.send(formData);
