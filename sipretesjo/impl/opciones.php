      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup" >
        <div class="navbar-nav ml-auto">
          <a class="nav-link active" aria-current="page" href=""><b></b></a>
            <a class="nav-link active" href="proc_examen.html" style="font-size: 18px;">PROCESO DE INGRESO</a>
        ...
        <div class="container">
                ...
                <div class="card card-custom">
                  ...
                  <div class="card-body">
                    ...
                    <a href="subir.php" class="btn btn-primary">Subir documentos</a>
