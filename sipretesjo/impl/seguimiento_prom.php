	...
	<nav class="navbar navbar-expand-lg bg-body-tertiary">
		<div class="container-fluid">
			...
			<div class="navbar-nav ml-auto">
				...
				<a class="nav-link active" href="proc_prom.html" style="font-size: 18px;"><b>PROCESO DE INGRESO</b></a>
    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
		  ...
		  <div class="col-md-3">
		  <a class="btn btn-success" href="opciones_prom.php" role="button">Regresar</a>
		  </div>
        </div>
      </div>
    </div>
